...
|--------------------------------------------------------|--------------------|--------------------------------------------------------|
| [ogg](http://www.vorbis.com/)                          | v1.3.4             | `https://github.com/xiph/ogg.git`                      |
...
| [freetype2](https://www.freetype.org/)                 | VER-2-10-4         | `https://gitlab.freedesktop.org/freetype/freetype.git` | 
